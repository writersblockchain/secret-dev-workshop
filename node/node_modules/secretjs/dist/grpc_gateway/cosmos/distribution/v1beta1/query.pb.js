...
class Query {
    ...
    static ValidatorDistributionInfo(req, initReq) {
        return fm.fetchReq(`/cosmos/distribution/v1beta1/validators/${req["validator_address"]}?${fm.renderURLSearchParams(req, ["validator_address"])}`, Object.assign(Object.assign({}, initReq), { method: "GET" }));
    }
