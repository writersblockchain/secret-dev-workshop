...
export declare type SignatureDescriptors = {
    signatures?: SignatureDescriptor[];
};
export declare type SignatureDescriptorDataSingle = {
    mode?: SignMode;
    signature?: Uint8Array;
};
export declare type SignatureDescriptorDataMulti = {
    bitarray?: CosmosCryptoMultisigV1beta1Multisig.CompactBitArray;
    signatures?: SignatureDescriptorData[];
};
declare type BaseSignatureDescriptorData = {};
export declare type SignatureDescriptorData = BaseSignatureDescriptorData & OneOf<{
    single: SignatureDescriptorDataSingle;
    multi: SignatureDescriptorDataMulti;
}>;
export declare type SignatureDescriptor = {
    public_key?: GoogleProtobufAny.Any;
    data?: SignatureDescriptorData;
    sequence?: string;
};
export {};
//# sourceMappingURL=signing.pb.d.ts.map