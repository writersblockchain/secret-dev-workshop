...
export declare type TxDecodeRequest = {
    tx_bytes?: Uint8Array;
};
export declare type TxDecodeResponse = {
    tx?: CosmosTxV1beta1Tx.Tx;
};
export declare type TxEncodeRequest = {
    tx?: CosmosTxV1beta1Tx.Tx;
};
export declare type TxEncodeResponse = {
    tx_bytes?: Uint8Array;
};
export declare type TxEncodeAminoRequest = {
    amino_json?: string;
};
export declare type TxEncodeAminoResponse = {
    amino_binary?: Uint8Array;
};
export declare type TxDecodeAminoRequest = {
    amino_binary?: Uint8Array;
};
export declare type TxDecodeAminoResponse = {
    amino_json?: string;
};
