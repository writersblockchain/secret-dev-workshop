...
class Service {
    ...
    static TxDecode(req, initReq) {
        return fm.fetchReq(`/cosmos/tx/v1beta1/decode`, Object.assign(Object.assign({}, initReq), { method: "POST", body: JSON.stringify(req, fm.replacer) }));
    }
    static TxEncode(req, initReq) {
        return fm.fetchReq(`/cosmos/tx/v1beta1/encode`, Object.assign(Object.assign({}, initReq), { method: "POST", body: JSON.stringify(req, fm.replacer) }));
    }
    static TxEncodeAmino(req, initReq) {
        return fm.fetchReq(`/cosmos/tx/v1beta1/encode/amino`, Object.assign(Object.assign({}, initReq), { method: "POST", body: JSON.stringify(req, fm.replacer) }));
    }
    static TxDecodeAmino(req, initReq) {
        return fm.fetchReq(`/cosmos/tx/v1beta1/decode/amino`, Object.assign(Object.assign({}, initReq), { method: "POST", body: JSON.stringify(req, fm.replacer) }));
    }
}
