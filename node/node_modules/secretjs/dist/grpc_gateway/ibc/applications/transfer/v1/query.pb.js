...
class Query {
    ...
    static TotalEscrowForDenom(req, initReq) {
        return fm.fetchReq(`/ibc/apps/transfer/v1/denoms/${req["denom=**"]}/total_escrow?${fm.renderURLSearchParams(req, ["denom=**"])}`, Object.assign(Object.assign({}, initReq), { method: "GET" }));
    }
}
exports.Query = Query;
