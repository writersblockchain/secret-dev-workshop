...
export declare type QueryNextSequenceSendRequest = {
    port_id?: string;
    channel_id?: string;
};
export declare type QueryNextSequenceSendResponse = {
    next_sequence_send?: string;
    proof?: Uint8Array;
    proof_height?: IbcCoreClientV1Client.Height;
};
export declare type QueryUpgradeErrorRequest = {
    port_id?: string;
    channel_id?: string;
};
export declare type QueryUpgradeErrorResponse = {
    error_receipt?: IbcCoreChannelV1Channel_upgrade.ErrorReceipt;
    proof?: Uint8Array;
    proof_height?: IbcCoreClientV1Client.Height;
};
export declare type QueryUpgradeRequest = {
    port_id?: string;
    channel_id?: string;
};
export declare type QueryUpgradeResponse = {
    upgrade?: IbcCoreChannelV1Channel_upgrade.Upgrade;
    proof?: Uint8Array;
    proof_height?: IbcCoreClientV1Client.Height;
};
export declare type QueryChannelParamsRequest = {};
export declare type QueryChannelParamsResponse = {
