...
class Query {
    ...
    static NextSequenceSend(req, initReq) {
        return fm.fetchReq(`/ibc/core/channel/v1/channels/${req["channel_id"]}/ports/${req["port_id"]}/next_sequence_send?${fm.renderURLSearchParams(req, ["channel_id", "port_id"])}`, Object.assign(Object.assign({}, initReq), { method: "GET" }));
    }
    static UpgradeError(req, initReq) {
        return fm.fetchReq(`/ibc/core/channel/v1/channels/${req["channel_id"]}/ports/${req["port_id"]}/upgrade_error?${fm.renderURLSearchParams(req, ["channel_id", "port_id"])}`, Object.assign(Object.assign({}, initReq), { method: "GET" }));
    }
    static Upgrade(req, initReq) {
        return fm.fetchReq(`/ibc/core/channel/v1/channels/${req["channel_id"]}/ports/${req["port_id"]}/upgrade?${fm.renderURLSearchParams(req, ["channel_id", "port_id"])}`, Object.assign(Object.assign({}, initReq), { method: "GET" }));
    }
    static ChannelParams(req, initReq) {
        return fm.fetchReq(`/ibc/core/channel/v1/params?${fm.renderURLSearchParams(req, [])}`, Object.assign(Object.assign({}, initReq), { method: "GET" }));
    }
}
exports.Query = Query;
