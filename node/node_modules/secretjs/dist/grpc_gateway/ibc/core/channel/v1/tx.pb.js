...
class Msg {
    ...
    static ChannelUpgradeInit(req, initReq) {
        return fm.fetchReq(`/ibc.core.channel.v1.Msg/ChannelUpgradeInit`, Object.assign(Object.assign({}, initReq), { method: "POST", body: JSON.stringify(req, fm.replacer) }));
    }
    static ChannelUpgradeTry(req, initReq) {
        return fm.fetchReq(`/ibc.core.channel.v1.Msg/ChannelUpgradeTry`, Object.assign(Object.assign({}, initReq), { method: "POST", body: JSON.stringify(req, fm.replacer) }));
    }
    static ChannelUpgradeAck(req, initReq) {
        return fm.fetchReq(`/ibc.core.channel.v1.Msg/ChannelUpgradeAck`, Object.assign(Object.assign({}, initReq), { method: "POST", body: JSON.stringify(req, fm.replacer) }));
    }
    static ChannelUpgradeConfirm(req, initReq) {
        return fm.fetchReq(`/ibc.core.channel.v1.Msg/ChannelUpgradeConfirm`, Object.assign(Object.assign({}, initReq), { method: "POST", body: JSON.stringify(req, fm.replacer) }));
    }
    static ChannelUpgradeOpen(req, initReq) {
        return fm.fetchReq(`/ibc.core.channel.v1.Msg/ChannelUpgradeOpen`, Object.assign(Object.assign({}, initReq), { method: "POST", body: JSON.stringify(req, fm.replacer) }));
    }
    static ChannelUpgradeTimeout(req, initReq) {
        return fm.fetchReq(`/ibc.core.channel.v1.Msg/ChannelUpgradeTimeout`, Object.assign(Object.assign({}, initReq), { method: "POST", body: JSON.stringify(req, fm.replacer) }));
    }
    static ChannelUpgradeCancel(req, initReq) {
        return fm.fetchReq(`/ibc.core.channel.v1.Msg/ChannelUpgradeCancel`, Object.assign(Object.assign({}, initReq), { method: "POST", body: JSON.stringify(req, fm.replacer) }));
    }
    static UpdateChannelParams(req, initReq) {
        return fm.fetchReq(`/ibc.core.channel.v1.Msg/UpdateChannelParams`, Object.assign(Object.assign({}, initReq), { method: "POST", body: JSON.stringify(req, fm.replacer) }));
    }
    static PruneAcknowledgements(req, initReq) {
        return fm.fetchReq(`/ibc.core.channel.v1.Msg/PruneAcknowledgements`, Object.assign(Object.assign({}, initReq), { method: "POST", body: JSON.stringify(req, fm.replacer) }));
    }
}
exports.Msg = Msg;
