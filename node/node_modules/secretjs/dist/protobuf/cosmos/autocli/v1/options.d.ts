...
export declare const ModuleOptions: {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number | undefined): ModuleOptions;
...
export declare const ServiceCommandDescriptor: {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number | undefined): ServiceCommandDescriptor;
    ...
    } | undefined): ServiceCommandDescriptor;
...
export declare const ServiceCommandDescriptor_SubCommandsEntry: {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number | undefined): ServiceCommandDescriptor_SubCommandsEntry;
    ...
    } | undefined): ServiceCommandDescriptor_SubCommandsEntry;
...
export declare const RpcCommandOptions: {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number | undefined): RpcCommandOptions;
...
export declare const RpcCommandOptions_FlagOptionsEntry: {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number | undefined): RpcCommandOptions_FlagOptionsEntry;
    ...
    } | undefined): RpcCommandOptions_FlagOptionsEntry;
...
export declare const FlagOptions: {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number | undefined): FlagOptions;
...
export declare const PositionalArgDescriptor: {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number | undefined): PositionalArgDescriptor;
    fromJSON(object: any): PositionalArgDescriptor;
    toJSON(message: PositionalArgDescriptor): unknown;
    create(base?: {
        proto_field?: string | undefined;
        varargs?: boolean | undefined;
    } | undefined): PositionalArgDescriptor;
