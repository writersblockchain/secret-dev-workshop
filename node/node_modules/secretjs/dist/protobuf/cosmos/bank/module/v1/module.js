...
exports.Module = {
    ...
    fromJSON(object) {
        return {
            blocked_module_accounts_override: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.blocked_module_accounts_override)
                ? object.blocked_module_accounts_override.map((e) => globalThis.String(e))
                : [],
    ...
    toJSON(message) {
        var _a;
        const obj = {};
        if ((_a = message.blocked_module_accounts_override) === null || _a === void 0 ? void 0 : _a.length) {
    ...
    fromPartial(object) {
        var _a, _b;
        const message = createBaseModule();
        message.blocked_module_accounts_override = ((_a = object.blocked_module_accounts_override) === null || _a === void 0 ? void 0 : _a.map((e) => e)) || [];
