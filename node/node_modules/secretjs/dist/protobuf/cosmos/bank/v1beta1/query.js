...
exports.QueryAllBalancesRequest = {
    ...
    fromPartial(object) {
        ...
        message.pagination = (object.pagination !== undefined && object.pagination !== null)
            ...
            : undefined;
        message.resolve_denom = (_b = object.resolve_denom) !== null && _b !== void 0 ? _b : false;
        return message;
    },
};
...
exports.QueryDenomMetadataByQueryStringRequest = {
    ...
    create(base) {
        return exports.QueryDenomMetadataByQueryStringRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseQueryDenomMetadataByQueryStringRequest();
...
exports.QueryDenomMetadataByQueryStringResponse = {
    ...
    create(base) {
        return exports.QueryDenomMetadataByQueryStringResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        const message = createBaseQueryDenomMetadataByQueryStringResponse();
        message.metadata = (object.metadata !== undefined && object.metadata !== null)
...
exports.QueryDenomOwnersResponse = {
    ...
    fromJSON(object) {
        return {
            denom_owners: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.denom_owners)
                ? object.denom_owners.map((e) => exports.DenomOwner.fromJSON(e))
                : [],
            pagination: isSet(object.pagination) ? pagination_1.PageResponse.fromJSON(object.pagination) : undefined,
        };
    },
    toJSON(message) {
        var _a;
        const obj = {};
        if ((_a = message.denom_owners) === null || _a === void 0 ? void 0 : _a.length) {
            obj.denom_owners = message.denom_owners.map((e) => exports.DenomOwner.toJSON(e));
        }
        if (message.pagination !== undefined) {
            obj.pagination = pagination_1.PageResponse.toJSON(message.pagination);
        }
    ...
    fromPartial(object) {
        var _a;
        const message = createBaseQueryDenomOwnersResponse();
        message.denom_owners = ((_a = object.denom_owners) === null || _a === void 0 ? void 0 : _a.map((e) => exports.DenomOwner.fromPartial(e))) || [];
        message.pagination = (object.pagination !== undefined && object.pagination !== null)
            ? pagination_1.PageResponse.fromPartial(object.pagination)
            : undefined;
        return message;
...
exports.QueryDenomOwnersByQueryRequest = {
    ...
    create(base) {
        return exports.QueryDenomOwnersByQueryRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseQueryDenomOwnersByQueryRequest();
...
exports.QueryDenomOwnersByQueryResponse = {
    ...
    create(base) {
        return exports.QueryDenomOwnersByQueryResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseQueryDenomOwnersByQueryResponse();
...
exports.QuerySendEnabledResponse = {
    ...
    fromPartial(object) {
        var _a;
        const message = createBaseQuerySendEnabledResponse();
        message.send_enabled = ((_a = object.send_enabled) === null || _a === void 0 ? void 0 : _a.map((e) => bank_1.SendEnabled.fromPartial(e))) || [];
        message.pagination = (object.pagination !== undefined && object.pagination !== null)
            ? pagination_1.PageResponse.fromPartial(object.pagination)
            : undefined;
        return message;
...
class QueryClientImpl {
    ...
    Balance(request) {
        ...
        return promise.then((data) => exports.QueryBalanceResponse.decode(_m0.Reader.create(data)));
    }
    AllBalances(request) {
        ...
        return promise.then((data) => exports.QueryAllBalancesResponse.decode(_m0.Reader.create(data)));
    }
    SpendableBalances(request) {
        ...
        return promise.then((data) => exports.QuerySpendableBalancesResponse.decode(_m0.Reader.create(data)));
    }
    SpendableBalanceByDenom(request) {
        ...
        return promise.then((data) => exports.QuerySpendableBalanceByDenomResponse.decode(_m0.Reader.create(data)));
    }
    TotalSupply(request) {
        ...
        return promise.then((data) => exports.QueryTotalSupplyResponse.decode(_m0.Reader.create(data)));
    }
    SupplyOf(request) {
        const data = exports.QuerySupplyOfRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "SupplyOf", data);
        return promise.then((data) => exports.QuerySupplyOfResponse.decode(_m0.Reader.create(data)));
    }
    Params(request) {
    ...
    DenomMetadata(request) {
        ...
        return promise.then((data) => exports.QueryDenomMetadataResponse.decode(_m0.Reader.create(data)));
    }
    DenomMetadataByQueryString(request) {
        ...
        return promise.then((data) => exports.QueryDenomMetadataByQueryStringResponse.decode(_m0.Reader.create(data)));
    }
    DenomsMetadata(request) {
        ...
        return promise.then((data) => exports.QueryDenomsMetadataResponse.decode(_m0.Reader.create(data)));
    }
    DenomOwners(request) {
        ...
        return promise.then((data) => exports.QueryDenomOwnersResponse.decode(_m0.Reader.create(data)));
    }
    DenomOwnersByQuery(request) {
        ...
        return promise.then((data) => exports.QueryDenomOwnersByQueryResponse.decode(_m0.Reader.create(data)));
    }
    SendEnabled(request) {
        ...
        return promise.then((data) => exports.QuerySendEnabledResponse.decode(_m0.Reader.create(data)));
    }
}
