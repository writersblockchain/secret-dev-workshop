...
exports.TxDescriptor = {
    ...
    fromJSON(object) {
        return {
            ...
            msgs: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.msgs) ? object.msgs.map((e) => exports.MsgDescriptor.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        var _a;
...
exports.AuthnDescriptor = {
    ...
    fromJSON(object) {
        return {
            sign_modes: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.sign_modes)
    ...
    toJSON(message) {
        var _a;
        const obj = {};
        if ((_a = message.sign_modes) === null || _a === void 0 ? void 0 : _a.length) {
    ...
    fromPartial(object) {
        var _a;
        const message = createBaseAuthnDescriptor();
        message.sign_modes = ((_a = object.sign_modes) === null || _a === void 0 ? void 0 : _a.map((e) => exports.SigningModeDescriptor.fromPartial(e))) || [];
        return message;
    },
};
...
exports.CodecDescriptor = {
    ...
    fromJSON(object) {
        return {
            interfaces: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.interfaces)
    ...
    toJSON(message) {
        var _a;
        const obj = {};
        if ((_a = message.interfaces) === null || _a === void 0 ? void 0 : _a.length) {
...
exports.InterfaceDescriptor = {
    ...
    fromJSON(object) {
        return {
            fullname: isSet(object.fullname) ? globalThis.String(object.fullname) : "",
            interface_accepting_messages: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.interface_accepting_messages)
                ? object.interface_accepting_messages.map((e) => exports.InterfaceAcceptingMessageDescriptor.fromJSON(e))
                : [],
            interface_implementers: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.interface_implementers)
    ...
    toJSON(message) {
        ...
        if ((_a = message.interface_accepting_messages) === null || _a === void 0 ? void 0 : _a.length) {
        ...
        if ((_b = message.interface_implementers) === null || _b === void 0 ? void 0 : _b.length) {
...
exports.InterfaceAcceptingMessageDescriptor = {
    ...
    fromJSON(object) {
        return {
            fullname: isSet(object.fullname) ? globalThis.String(object.fullname) : "",
            field_descriptor_names: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.field_descriptor_names)
    ...
    toJSON(message) {
        ...
        if ((_a = message.field_descriptor_names) === null || _a === void 0 ? void 0 : _a.length) {
    ...
    fromPartial(object) {
        ...
        const message = createBaseInterfaceAcceptingMessageDescriptor();
        message.fullname = (_a = object.fullname) !== null && _a !== void 0 ? _a : "";
        message.field_descriptor_names = ((_b = object.field_descriptor_names) === null || _b === void 0 ? void 0 : _b.map((e) => e)) || [];
        return message;
    },
};
...
exports.QueryServicesDescriptor = {
    ...
    fromJSON(object) {
        return {
            query_services: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.query_services)
    ...
    toJSON(message) {
        var _a;
        const obj = {};
        if ((_a = message.query_services) === null || _a === void 0 ? void 0 : _a.length) {
    ...
    fromPartial(object) {
        var _a;
        const message = createBaseQueryServicesDescriptor();
        message.query_services = ((_a = object.query_services) === null || _a === void 0 ? void 0 : _a.map((e) => exports.QueryServiceDescriptor.fromPartial(e))) || [];
        return message;
    },
};
...
exports.QueryServiceDescriptor = {
    ...
    fromJSON(object) {
        return {
            ...
            methods: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.methods)
...
exports.ReflectionServiceServiceName = "cosmos.base.reflection.v2alpha1.ReflectionService";
class ReflectionServiceClientImpl {
    ...
    GetAuthnDescriptor(request) {
        ...
        return promise.then((data) => exports.GetAuthnDescriptorResponse.decode(_m0.Reader.create(data)));
    }
    GetChainDescriptor(request) {
        ...
        return promise.then((data) => exports.GetChainDescriptorResponse.decode(_m0.Reader.create(data)));
    }
    GetCodecDescriptor(request) {
        ...
        return promise.then((data) => exports.GetCodecDescriptorResponse.decode(_m0.Reader.create(data)));
    }
    GetConfigurationDescriptor(request) {
        ...
        return promise.then((data) => exports.GetConfigurationDescriptorResponse.decode(_m0.Reader.create(data)));
    }
    GetQueryServicesDescriptor(request) {
        ...
        return promise.then((data) => exports.GetQueryServicesDescriptorResponse.decode(_m0.Reader.create(data)));
    }
    GetTxDescriptor(request) {
        ...
        return promise.then((data) => exports.GetTxDescriptorResponse.decode(_m0.Reader.create(data)));
    }
}
