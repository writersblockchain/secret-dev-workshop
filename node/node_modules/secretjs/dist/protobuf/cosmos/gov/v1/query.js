...
exports.QueryConstitutionRequest = {
    ...
    create(base) {
        return exports.QueryConstitutionRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(_) {
        const message = createBaseQueryConstitutionRequest();
        return message;
...
exports.QueryConstitutionResponse = {
    ...
    create(base) {
        return exports.QueryConstitutionResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseQueryConstitutionResponse();
...
exports.QueryVotesResponse = {
    ...
    fromJSON(object) {
        return {
            votes: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.votes) ? object.votes.map((e) => gov_1.Vote.fromJSON(e)) : [],
            pagination: isSet(object.pagination) ? pagination_1.PageResponse.fromJSON(object.pagination) : undefined,
        };
    },
    toJSON(message) {
...
exports.QueryParamsResponse = {
    ...
    toJSON(message) {
        const obj = {};
        if (message.voting_params !== undefined) {
            obj.voting_params = gov_1.VotingParams.toJSON(message.voting_params);
        }
        if (message.deposit_params !== undefined) {
            obj.deposit_params = gov_1.DepositParams.toJSON(message.deposit_params);
        }
        if (message.tally_params !== undefined) {
            obj.tally_params = gov_1.TallyParams.toJSON(message.tally_params);
        }
        if (message.params !== undefined) {
...
exports.QueryDepositsResponse = {
    ...
    fromJSON(object) {
        return {
            deposits: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.deposits) ? object.deposits.map((e) => gov_1.Deposit.fromJSON(e)) : [],
            pagination: isSet(object.pagination) ? pagination_1.PageResponse.fromJSON(object.pagination) : undefined,
        };
    },
    toJSON(message) {
...
exports.QueryServiceName = "cosmos.gov.v1.Query";
class QueryClientImpl {
    ...
    Deposit(request) {
        ...
        return promise.then((data) => exports.QueryDepositResponse.decode(_m0.Reader.create(data)));
    }
    Deposits(request) {
        const data = exports.QueryDepositsRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "Deposits", data);
        return promise.then((data) => exports.QueryDepositsResponse.decode(_m0.Reader.create(data)));
    }
    TallyResult(request) {
        ...
        return promise.then((data) => exports.QueryTallyResultResponse.decode(_m0.Reader.create(data)));
    }
}
