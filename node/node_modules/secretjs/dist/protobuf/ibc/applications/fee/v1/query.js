...
exports.QueryIncentivizedPacketsResponse = {
    ...
    fromJSON(object) {
        return {
            incentivized_packets: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.incentivized_packets)
    ...
    toJSON(message) {
        var _a;
        const obj = {};
        if ((_a = message.incentivized_packets) === null || _a === void 0 ? void 0 : _a.length) {
            obj.incentivized_packets = message.incentivized_packets.map((e) => fee_1.IdentifiedPacketFees.toJSON(e));
        }
        if (message.pagination !== undefined) {
    ...
    fromPartial(object) {
        var _a;
        const message = createBaseQueryIncentivizedPacketsResponse();
        message.incentivized_packets = ((_a = object.incentivized_packets) === null || _a === void 0 ? void 0 : _a.map((e) => fee_1.IdentifiedPacketFees.fromPartial(e))) || [];
        message.pagination = (object.pagination !== undefined && object.pagination !== null)
...
exports.QueryIncentivizedPacketResponse = {
    ...
    toJSON(message) {
        const obj = {};
        if (message.incentivized_packet !== undefined) {
            obj.incentivized_packet = fee_1.IdentifiedPacketFees.toJSON(message.incentivized_packet);
        }
        return obj;
    },
    create(base) {
...
exports.QueryTotalRecvFeesRequest = {
    ...
    fromJSON(object) {
        return { packet_id: isSet(object.packet_id) ? channel_1.PacketId.fromJSON(object.packet_id) : undefined };
    },
    toJSON(message) {
        const obj = {};
        if (message.packet_id !== undefined) {
...
exports.QueryTotalRecvFeesResponse = {
    ...
    fromJSON(object) {
        return {
            recv_fees: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.recv_fees) ? object.recv_fees.map((e) => coin_1.Coin.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        var _a;
        const obj = {};
        if ((_a = message.recv_fees) === null || _a === void 0 ? void 0 : _a.length) {
            obj.recv_fees = message.recv_fees.map((e) => coin_1.Coin.toJSON(e));
        }
        return obj;
    },
    create(base) {
...
exports.QueryTotalAckFeesResponse = {
    ...
    fromJSON(object) {
        return {
            ack_fees: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.ack_fees) ? object.ack_fees.map((e) => coin_1.Coin.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        var _a;
        const obj = {};
        if ((_a = message.ack_fees) === null || _a === void 0 ? void 0 : _a.length) {
            obj.ack_fees = message.ack_fees.map((e) => coin_1.Coin.toJSON(e));
        }
        return obj;
    },
    create(base) {
...
exports.QueryTotalTimeoutFeesResponse = {
    ...
    fromJSON(object) {
        return {
            timeout_fees: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.timeout_fees)
    ...
    toJSON(message) {
        var _a;
        const obj = {};
        if ((_a = message.timeout_fees) === null || _a === void 0 ? void 0 : _a.length) {
            obj.timeout_fees = message.timeout_fees.map((e) => coin_1.Coin.toJSON(e));
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        var _a;
        const message = createBaseQueryTotalTimeoutFeesResponse();
        message.timeout_fees = ((_a = object.timeout_fees) === null || _a === void 0 ? void 0 : _a.map((e) => coin_1.Coin.fromPartial(e))) || [];
        return message;
    },
};
...
exports.QueryFeeEnabledChannelsResponse = {
    ...
    fromJSON(object) {
        return {
            fee_enabled_channels: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.fee_enabled_channels)
    ...
    toJSON(message) {
        var _a;
        const obj = {};
        if ((_a = message.fee_enabled_channels) === null || _a === void 0 ? void 0 : _a.length) {
            obj.fee_enabled_channels = message.fee_enabled_channels.map((e) => genesis_1.FeeEnabledChannel.toJSON(e));
        }
        if (message.pagination !== undefined) {
            obj.pagination = pagination_1.PageResponse.toJSON(message.pagination);
        }
    ...
    fromPartial(object) {
        var _a;
        const message = createBaseQueryFeeEnabledChannelsResponse();
        message.fee_enabled_channels = ((_a = object.fee_enabled_channels) === null || _a === void 0 ? void 0 : _a.map((e) => genesis_1.FeeEnabledChannel.fromPartial(e))) || [];
        message.pagination = (object.pagination !== undefined && object.pagination !== null)
            ? pagination_1.PageResponse.fromPartial(object.pagination)
            : undefined;
        return message;
...
class QueryClientImpl {
    ...
    IncentivizedPackets(request) {
        ...
        return promise.then((data) => exports.QueryIncentivizedPacketsResponse.decode(_m0.Reader.create(data)));
    }
    IncentivizedPacket(request) {
        ...
        return promise.then((data) => exports.QueryIncentivizedPacketResponse.decode(_m0.Reader.create(data)));
    }
    IncentivizedPacketsForChannel(request) {
        ...
        return promise.then((data) => exports.QueryIncentivizedPacketsForChannelResponse.decode(_m0.Reader.create(data)));
    }
    TotalRecvFees(request) {
        ...
        return promise.then((data) => exports.QueryTotalRecvFeesResponse.decode(_m0.Reader.create(data)));
    }
    TotalAckFees(request) {
        ...
        return promise.then((data) => exports.QueryTotalAckFeesResponse.decode(_m0.Reader.create(data)));
    }
    TotalTimeoutFees(request) {
        ...
        return promise.then((data) => exports.QueryTotalTimeoutFeesResponse.decode(_m0.Reader.create(data)));
    }
    Payee(request) {
        const data = exports.QueryPayeeRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "Payee", data);
        return promise.then((data) => exports.QueryPayeeResponse.decode(_m0.Reader.create(data)));
    }
    CounterpartyPayee(request) {
        ...
        return promise.then((data) => exports.QueryCounterpartyPayeeResponse.decode(_m0.Reader.create(data)));
    }
    FeeEnabledChannels(request) {
        ...
        return promise.then((data) => exports.QueryFeeEnabledChannelsResponse.decode(_m0.Reader.create(data)));
    }
    FeeEnabledChannel(request) {
        ...
        return promise.then((data) => exports.QueryFeeEnabledChannelResponse.decode(_m0.Reader.create(data)));
    }
}
