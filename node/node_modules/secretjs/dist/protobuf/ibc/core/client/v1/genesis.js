...
exports.GenesisState = {
    ...
    fromJSON(object) {
        return {
            clients: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.clients)
                ...
                : [],
            clients_consensus: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.clients_consensus)
                ? object.clients_consensus.map((e) => client_1.ClientConsensusStates.fromJSON(e))
                : [],
            clients_metadata: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.clients_metadata)
    ...
    toJSON(message) {
        ...
        if ((_b = message.clients_consensus) === null || _b === void 0 ? void 0 : _b.length) {
            obj.clients_consensus = message.clients_consensus.map((e) => client_1.ClientConsensusStates.toJSON(e));
        }
        if ((_c = message.clients_metadata) === null || _c === void 0 ? void 0 : _c.length) {
            obj.clients_metadata = message.clients_metadata.map((e) => exports.IdentifiedGenesisMetadata.toJSON(e));
        }
        if (message.params !== undefined) {
    ...
    fromPartial(object) {
        ...
        message.clients_consensus = ((_b = object.clients_consensus) === null || _b === void 0 ? void 0 : _b.map((e) => client_1.ClientConsensusStates.fromPartial(e))) || [];
        message.clients_metadata = ((_c = object.clients_metadata) === null || _c === void 0 ? void 0 : _c.map((e) => exports.IdentifiedGenesisMetadata.fromPartial(e))) || [];
...
exports.IdentifiedGenesisMetadata = {
    ...
    fromJSON(object) {
        return {
            ...
            client_metadata: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.client_metadata)
    ...
    toJSON(message) {
        ...
        if ((_a = message.client_metadata) === null || _a === void 0 ? void 0 : _a.length) {
            obj.client_metadata = message.client_metadata.map((e) => exports.GenesisMetadata.toJSON(e));
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.client_metadata = ((_b = object.client_metadata) === null || _b === void 0 ? void 0 : _b.map((e) => exports.GenesisMetadata.fromPartial(e))) || [];
        return message;
    },
};
