...
exports.ClientState = {
    ...
    fromJSON(object) {
        return {
            ...
            trust_level: isSet(object.trust_level) ? exports.Fraction.fromJSON(object.trust_level) : undefined,
            trusting_period: isSet(object.trusting_period) ? duration_1.Duration.fromJSON(object.trusting_period) : undefined,
            unbonding_period: isSet(object.unbonding_period) ? duration_1.Duration.fromJSON(object.unbonding_period) : undefined,
            max_clock_drift: isSet(object.max_clock_drift) ? duration_1.Duration.fromJSON(object.max_clock_drift) : undefined,
            frozen_height: isSet(object.frozen_height) ? client_1.Height.fromJSON(object.frozen_height) : undefined,
            latest_height: isSet(object.latest_height) ? client_1.Height.fromJSON(object.latest_height) : undefined,
            proof_specs: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.proof_specs)
                ? object.proof_specs.map((e) => proofs_1.ProofSpec.fromJSON(e))
                : [],
            upgrade_path: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.upgrade_path)
                ? object.upgrade_path.map((e) => globalThis.String(e))
                : [],
    ...
    toJSON(message) {
        ...
        if (message.trust_level !== undefined) {
            obj.trust_level = exports.Fraction.toJSON(message.trust_level);
        }
        if (message.trusting_period !== undefined) {
            obj.trusting_period = duration_1.Duration.toJSON(message.trusting_period);
        }
        if (message.unbonding_period !== undefined) {
            obj.unbonding_period = duration_1.Duration.toJSON(message.unbonding_period);
        }
        if (message.max_clock_drift !== undefined) {
            obj.max_clock_drift = duration_1.Duration.toJSON(message.max_clock_drift);
        }
        if (message.frozen_height !== undefined) {
            obj.frozen_height = client_1.Height.toJSON(message.frozen_height);
        }
        if (message.latest_height !== undefined) {
            obj.latest_height = client_1.Height.toJSON(message.latest_height);
        }
        if ((_a = message.proof_specs) === null || _a === void 0 ? void 0 : _a.length) {
            obj.proof_specs = message.proof_specs.map((e) => proofs_1.ProofSpec.toJSON(e));
        }
        if ((_b = message.upgrade_path) === null || _b === void 0 ? void 0 : _b.length) {
    ...
    fromPartial(object) {
        ...
        message.latest_height = (object.latest_height !== undefined && object.latest_height !== null)
            ...
            : undefined;
        message.proof_specs = ((_b = object.proof_specs) === null || _b === void 0 ? void 0 : _b.map((e) => proofs_1.ProofSpec.fromPartial(e))) || [];
        message.upgrade_path = ((_c = object.upgrade_path) === null || _c === void 0 ? void 0 : _c.map((e) => e)) || [];
        message.allow_update_after_expiry = (_d = object.allow_update_after_expiry) !== null && _d !== void 0 ? _d : false;
        message.allow_update_after_misbehaviour = (_e = object.allow_update_after_misbehaviour) !== null && _e !== void 0 ? _e : false;
        return message;
    },
};
...
exports.ConsensusState = {
    ...
    fromPartial(object) {
        ...
        message.root = (object.root !== undefined && object.root !== null)
            ...
            : undefined;
        message.next_validators_hash = (_a = object.next_validators_hash) !== null && _a !== void 0 ? _a : new Uint8Array(0);
        return message;
    },
};
...
exports.Misbehaviour = {
    ...
    fromJSON(object) {
        return {
            ...
            header_1: isSet(object.header_1) ? exports.Header.fromJSON(object.header_1) : undefined,
            header_2: isSet(object.header_2) ? exports.Header.fromJSON(object.header_2) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.header_1 !== undefined) {
            obj.header_1 = exports.Header.toJSON(message.header_1);
        }
        if (message.header_2 !== undefined) {
            obj.header_2 = exports.Header.toJSON(message.header_2);
        }
        return obj;
    },
    create(base) {
...
exports.Header = {
    ...
    fromJSON(object) {
        return {
            signed_header: isSet(object.signed_header) ? types_1.SignedHeader.fromJSON(object.signed_header) : undefined,
            validator_set: isSet(object.validator_set) ? validator_1.ValidatorSet.fromJSON(object.validator_set) : undefined,
            trusted_height: isSet(object.trusted_height) ? client_1.Height.fromJSON(object.trusted_height) : undefined,
    ...
    toJSON(message) {
        const obj = {};
        if (message.signed_header !== undefined) {
            obj.signed_header = types_1.SignedHeader.toJSON(message.signed_header);
        }
        if (message.validator_set !== undefined) {
            obj.validator_set = validator_1.ValidatorSet.toJSON(message.validator_set);
        }
        if (message.trusted_height !== undefined) {
            obj.trusted_height = client_1.Height.toJSON(message.trusted_height);
        }
        if (message.trusted_validators !== undefined) {
            obj.trusted_validators = validator_1.ValidatorSet.toJSON(message.trusted_validators);
        }
        return obj;
    },
    create(base) {
