...
exports.NewValidBlock = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.block_part_set_header !== undefined) {
            types_2.PartSetHeader.encode(message.block_part_set_header, writer.uint32(26).fork()).ldelim();
        }
        if (message.block_parts !== undefined) {
            types_1.BitArray.encode(message.block_parts, writer.uint32(34).fork()).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 3:
                    ...
                    message.block_part_set_header = types_2.PartSetHeader.decode(reader, reader.uint32());
                    continue;
                case 4:
                    if (tag !== 34) {
                        break;
                    }
                    message.block_parts = types_1.BitArray.decode(reader, reader.uint32());
                    continue;
                case 5:
                    if (tag !== 40) {
                        break;
    ...
    fromJSON(object) {
        return {
            ...
            block_part_set_header: isSet(object.block_part_set_header)
                ? types_2.PartSetHeader.fromJSON(object.block_part_set_header)
                : undefined,
            block_parts: isSet(object.block_parts) ? types_1.BitArray.fromJSON(object.block_parts) : undefined,
    ...
    toJSON(message) {
        ...
        if (message.block_part_set_header !== undefined) {
            obj.block_part_set_header = types_2.PartSetHeader.toJSON(message.block_part_set_header);
        }
        if (message.block_parts !== undefined) {
            obj.block_parts = types_1.BitArray.toJSON(message.block_parts);
        }
        if (message.is_commit !== false) {
    ...
    fromPartial(object) {
        ...
        message.block_part_set_header =
            (object.block_part_set_header !== undefined && object.block_part_set_header !== null)
                ? types_2.PartSetHeader.fromPartial(object.block_part_set_header)
                : undefined;
        message.block_parts = (object.block_parts !== undefined && object.block_parts !== null)
            ? types_1.BitArray.fromPartial(object.block_parts)
            : undefined;
...
exports.Proposal = {
    ...
    toJSON(message) {
        const obj = {};
        if (message.proposal !== undefined) {
            obj.proposal = types_2.Proposal.toJSON(message.proposal);
        }
        return obj;
    },
    create(base) {
...
exports.ProposalPOL = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.proposal_pol !== undefined) {
            types_1.BitArray.encode(message.proposal_pol, writer.uint32(26).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 3:
                    ...
                    message.proposal_pol = types_1.BitArray.decode(reader, reader.uint32());
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    fromJSON(object) {
        return {
            ...
            proposal_pol: isSet(object.proposal_pol) ? types_1.BitArray.fromJSON(object.proposal_pol) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.proposal_pol !== undefined) {
            obj.proposal_pol = types_1.BitArray.toJSON(message.proposal_pol);
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.proposal_pol = (object.proposal_pol !== undefined && object.proposal_pol !== null)
            ? types_1.BitArray.fromPartial(object.proposal_pol)
            : undefined;
        return message;
    },
};
...
exports.BlockPart = {
    ...
    toJSON(message) {
        ...
        if (message.part !== undefined) {
            obj.part = types_2.Part.toJSON(message.part);
        }
        return obj;
    },
    create(base) {
...
exports.Vote = {
    ...
    toJSON(message) {
        const obj = {};
        if (message.vote !== undefined) {
            obj.vote = types_2.Vote.toJSON(message.vote);
        }
        return obj;
    },
    create(base) {
...
exports.HasVote = {
    ...
    toJSON(message) {
        ...
        if (message.type !== 0) {
            obj.type = (0, types_2.signedMsgTypeToJSON)(message.type);
        }
        if (message.index !== 0) {
...
exports.VoteSetMaj23 = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.block_id !== undefined) {
            types_2.BlockID.encode(message.block_id, writer.uint32(34).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
...
exports.VoteSetBits = {
    ...
    toJSON(message) {
        ...
        if (message.votes !== undefined) {
            obj.votes = types_1.BitArray.toJSON(message.votes);
        }
        return obj;
    },
    create(base) {
...
exports.Message = {
    ...
    fromJSON(object) {
        return {
            new_round_step: isSet(object.new_round_step) ? exports.NewRoundStep.fromJSON(object.new_round_step) : undefined,
            new_valid_block: isSet(object.new_valid_block) ? exports.NewValidBlock.fromJSON(object.new_valid_block) : undefined,
            proposal: isSet(object.proposal) ? exports.Proposal.fromJSON(object.proposal) : undefined,
            proposal_pol: isSet(object.proposal_pol) ? exports.ProposalPOL.fromJSON(object.proposal_pol) : undefined,
            block_part: isSet(object.block_part) ? exports.BlockPart.fromJSON(object.block_part) : undefined,
            vote: isSet(object.vote) ? exports.Vote.fromJSON(object.vote) : undefined,
            has_vote: isSet(object.has_vote) ? exports.HasVote.fromJSON(object.has_vote) : undefined,
            vote_set_maj23: isSet(object.vote_set_maj23) ? exports.VoteSetMaj23.fromJSON(object.vote_set_maj23) : undefined,
            vote_set_bits: isSet(object.vote_set_bits) ? exports.VoteSetBits.fromJSON(object.vote_set_bits) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
        if (message.new_round_step !== undefined) {
            obj.new_round_step = exports.NewRoundStep.toJSON(message.new_round_step);
        }
        if (message.new_valid_block !== undefined) {
            obj.new_valid_block = exports.NewValidBlock.toJSON(message.new_valid_block);
        }
        if (message.proposal !== undefined) {
            obj.proposal = exports.Proposal.toJSON(message.proposal);
        }
        if (message.proposal_pol !== undefined) {
            obj.proposal_pol = exports.ProposalPOL.toJSON(message.proposal_pol);
        }
        if (message.block_part !== undefined) {
            obj.block_part = exports.BlockPart.toJSON(message.block_part);
        }
        if (message.vote !== undefined) {
            obj.vote = exports.Vote.toJSON(message.vote);
        }
        if (message.has_vote !== undefined) {
            obj.has_vote = exports.HasVote.toJSON(message.has_vote);
        }
        if (message.vote_set_maj23 !== undefined) {
            obj.vote_set_maj23 = exports.VoteSetMaj23.toJSON(message.vote_set_maj23);
        }
        if (message.vote_set_bits !== undefined) {
            obj.vote_set_bits = exports.VoteSetBits.toJSON(message.vote_set_bits);
        }
        return obj;
    },
    create(base) {
