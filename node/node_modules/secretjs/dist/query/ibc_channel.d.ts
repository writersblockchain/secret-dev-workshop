import { QueryChannelClientStateRequest, QueryChannelClientStateResponse, QueryChannelConsensusStateRequest, QueryChannelConsensusStateResponse, QueryChannelRequest, QueryChannelResponse, QueryChannelsRequest, QueryChannelsResponse, QueryConnectionChannelsRequest, QueryConnectionChannelsResponse, QueryNextSequenceReceiveRequest, QueryNextSequenceReceiveResponse, QueryPacketAcknowledgementRequest, QueryPacketAcknowledgementResponse, QueryPacketAcknowledgementsRequest, QueryPacketAcknowledgementsResponse, QueryPacketCommitmentRequest, QueryPacketCommitmentResponse, QueryPacketCommitmentsRequest, QueryPacketCommitmentsResponse, QueryPacketReceiptRequest, QueryPacketReceiptResponse, QueryUnreceivedAcksRequest, QueryUnreceivedAcksResponse, QueryUnreceivedPacketsRequest, QueryUnreceivedPacketsResponse, QueryChannelParamsRequest, QueryChannelParamsResponse, QueryNextSequenceSendRequest, QueryNextSequenceSendResponse, QueryUpgradeErrorRequest, QueryUpgradeErrorResponse, QueryUpgradeRequest, QueryUpgradeResponse } from "../grpc_gateway/ibc/core/channel/v1/query.pb";
export declare class IbcChannelQuerier {
    private url;
    constructor(url: string);
    channelParams(req: QueryChannelParamsRequest, headers?: HeadersInit): Promise<QueryChannelParamsResponse>;
    nextSequenceSend(req: QueryNextSequenceSendRequest, headers?: HeadersInit): Promise<QueryNextSequenceSendResponse>;
    upgradeError(req: QueryUpgradeErrorRequest, headers?: HeadersInit): Promise<QueryUpgradeErrorResponse>;
    upgrade(req: QueryUpgradeRequest, headers?: HeadersInit): Promise<QueryUpgradeResponse>;
