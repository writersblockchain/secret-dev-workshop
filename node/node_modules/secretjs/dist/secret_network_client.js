...
const gov_v1beta1_1 = require("./query/gov_v1beta1");
const gov_v1_1 = require("./query/gov_v1");
...
const consensus_1 = require("./query/consensus");
...
const orm_1 = require("./query/orm");
const app_1 = require("./query/app");
const autocli_1 = require("./query/autocli");
var BroadcastMode;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (typeof (error === null || error === void 0 ? void 0 : error.message) == "string" &&
                    ((_a = error === null || error === void 0 ? void 0 : error.message) === null || _a === void 0 ? void 0 : _a.match(txNotFoundRegex)) !== null) {
                    return null;
                }
                else {
                    throw error;
