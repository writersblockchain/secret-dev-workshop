...
import { MsgRevokeAllowance as MsgRevokeAllowanceParams, MsgPruneAllowances as MsgPruneAllowancesParams } from "../protobuf/cosmos/feegrant/v1beta1/tx";
import { AminoMsg, Msg, ProtoMsg, MsgParams } from "./types";
export { MsgRevokeAllowance as MsgRevokeAllowanceParams, MsgPruneAllowances as MsgPruneAllowancesParams, } from "../protobuf/cosmos/feegrant/v1beta1/tx";
...
/** MsgRevokeAllowance removes any existing Allowance from Granter to Grantee. */
export declare class MsgPruneAllowances implements Msg {
    params: MsgPruneAllowancesParams;
    constructor(params: MsgPruneAllowancesParams);
    toProto(): Promise<ProtoMsg>;
    toAmino(): Promise<AminoMsg>;
}
